...
if __name__ == '__main__':
    ...
    if not os.path.exists('outputs/content_timeseries/'):
        print('content_timeseries folder is missing. Creating it.')
        os.makedirs('outputs/content_timeseries/')
    ...
    for i, box in enumerate(boxes):
        ...
        biomass_content.to_netcdf(f'outputs/content_timeseries/box_{i}.nc')
